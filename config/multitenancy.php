...
return [
    ...
    /*
     * These fields are used by tenant:artisan command to match one or more tenants
     */
     ...
     * in a shared file using the `SpatieMultitenancy` facade
     */
     ...
     *
     * For example, using the package laravel-actions you can
     * resolve JobDecorator to getAction() like so: JobDecorator::class => 'getAction'
     */
    'queueable_to_job' => [
        \Spatie\Multitenancy\Jobs\TenantAwareJob::class => 'getActualJob',
    ],
     ...
     */
    'tenant_aware_jobs' => [
        // App\Jobs\YourJob::class,
    ],

    /*
     * Jobs not tenant aware even if these implement the TenantAware interface.
     */
